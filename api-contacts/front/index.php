		...
		<div class="row">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				<section class="accueil">
					...
					<div class="alert alert-warning my-5" role="alert"><strong>Note :</strong> la pagination dans les pages ne fonctionne pas et ne sert qu'à être visible.</div>
					<div class="row">
						<div class="col-md-6">
								...
								<div class="col-md-6 mw-100">
									<div class="card border-dark mb-3">
										<div class="card-body text-dark">
											<h5 class="card-title"><i class="fas fa-user"></i> Contacts</h5>
											<p class="card-text">Vous trouverez ici le nombre de contacts existants dans la base de données.</p>
											<p class="card-text" id="nbContacts"></p>
										</div>
									</div>
								</div>
								<div class="col-md-6 mw-100">
									<div class="card border-dark mb-3">
										<div class="card-body text-dark">
											<h5 class="card-title"><i class="fas fa-chart-line"></i> Catégories</h5>
				...
				<section class="col-md-6 ajout-contact" style="display: none">
				...
				<section class="col-md-6 modif-contact" style="display: none">
					<h2 class="mt-4">Modifier un contact</h2>
					<form>
						<div class="form-group">
							<label for="nom">Nom :</label>
							<input type="text" class="form-control" name="nom" id="nom" />
				...
				<section class="col-md-6 ajout-categorie" style="display: none">
				...
				<section class="col-md-6 modif-categorie" style="display: none">
					<h2 class="mt-4">Modifier une catégorie</h2>
					<form>
						<div class="form-group">
							<label for="nom">Nom :</label>
							<input type="text" class="form-control" name="nom" id="nom" />
